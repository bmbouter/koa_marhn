...
def viterbi_example():
    ...
    my_hmm.write_symbols_to_file_as_two_columns('viterbi_hmm_%s_col.csv' % iterations)
    my_hmm.write_symbols_to_file_as_two_rows('viterbi_hmm_%s_row.csv' % iterations)
